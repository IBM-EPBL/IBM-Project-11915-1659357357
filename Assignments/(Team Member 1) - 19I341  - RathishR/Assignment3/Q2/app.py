...
COS_API_KEY_ID = "hpfOBFYRDNYaZt895pIr-bG_fTYdmwxZl4yDByopeMZb" # eg "W00YixxxxxxxxxxMB-odB-2ySfTrFBIQQWanc--P3byk"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/ee2d087c53ec4129ac6c2027a6b4f44d::serviceid:ServiceId-868ba689-3cbc-47d0-9261-80710c70715c"
...
@app.route('/')
def index():
    files = get_bucket_contents('ranesh-bucket')
